...
| Straightforward self-contained coding task or fix | claude, opus, high effort (`--model opus --effort high`) → codex, gpt-6-astra, low effort (`--agent codex --model gpt-6-astra --effort low`) |
...
| Complicated coding (nuanced, multi-file, or history-rewriting) | codex, gpt-6-astra, high effort (`--agent codex --model gpt-6-astra --effort high`) |
